...
| 36 | 2026-02-22 | Integração Harbor: Criação de tarefas formais para Worker Assíncrono, Testes Unitários e Hardening Docker. Setup de workflow com LLM Local (Ollama Qwen 2.5 Coder 14B) para desenvolvimento agêntico sem custos de token. |
