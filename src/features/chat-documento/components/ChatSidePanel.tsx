                    ...
                    <>
                        ...
                        <div className="fixed inset-0 z-sgn-tooltip flex items-center justify-center p-0 sm:p-4 pointer-events-none">
                            <motion.div
                                ...
                                className="w-full h-full sm:w-[800px] sm:max-w-full sm:h-[85vh] sm:max-h-full bg-gray-50 dark:bg-[#0a0a0f] flex flex-col no-print shadow-2xl sm:rounded-2xl sm:border border-gray-200/60 dark:border-white/[0.06] overflow-hidden pointer-events-auto"
                            >
                                {/* Header */}
