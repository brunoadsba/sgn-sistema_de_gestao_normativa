...
export const AnaliseConformidadeResponseSchema = z.object({
...
export function injetarNumerosLinha(texto: string): string {
  return texto
    .split('\n')
...
export function parsearRespostaAnalise(response: string): AnaliseConformidadeResponse {
  try {
